...
export const PaahouaVang = forwardRef<any, PaahouaVangProps>((props, ref) => {
  ...
  return (
    <Grid ref={ref} container columnSpacing={6} rowGap={{ xs: 2, sm: 4, md: 12 }} className={`${css['provider']} ${value === pointer ? '' : css['hidden']} ${css[animationClass]}`}>
      ...
      <Grid item xs={12} sm={12} md={6} lg={6} className={css['photo-container-one']}>
        <TextBlock body={'Paahoua Vang'} classification={TextBlockClassification.title} className={css['provider-one']} />
      ...
      <Grid item xs={12} sm={12} md={6} lg={6} className={css['photo-container-one']}>
        <TextBlock body={'Love is Passion'} classification={TextBlockClassification.title} className={css['provider-one']} />
      ...
      <Grid item xs={12} sm={12} md={6} lg={6} className={css['photo-container-one']}>
        <TextBlock body={'Your Next Door Provider'} classification={TextBlockClassification.title} className={css['provider-one']} />
