...
export interface ProviderInfoTabletViewProps {
  imageCSSRender: string;
}

export const ProviderInfoTabletView: React.FC<ProviderInfoTabletViewProps> = (props) => {
  ...
  return (
    <Box className={css['container']}>
      <TabContext value={whichProviderIDNumber}>
        ...
        <TabPanel value={'1'} className={css['tab-panel-container-formatting']}>
          <Box sx={{ display: 'flex' }}>
        ...
        <TabPanel value={'2'} className={css['tab-panel-container-formatting']}>
          <Box className={css['photo-container-one']}>
        ...
        <TabPanel value={'3'} className={css['tab-panel-container-formatting']}>
          <Box className={css['photo-container-one']}>
